...
JPL = League(
    [
        ...
        ("Cercle brugge", (
            4, 8, 10, 16, 14, 13, 16+1, 16+6, 16+5, 15, 11, 16, 7, 9, 9, 9, 4, 12, 14, 11, 14, 11, 14, 18+1, 18+6, 18+7,
            18+8, 18+9, 18+10, 18, 8, 15, 12, 13, 9, 16, 9, 15, 7, 11, 10, 11, 11, 12, 14, 14, 10, 18+1, 17, 8, 13, 10,
            8, 11, 5, 16+11, 16+6, 16+4)),  # 1968/69 is the last year
        ("Krc genk", (
            5, 2, 8, 2, 7, 1, 5, 8, 4, 7, 6, 5, 3, 1, 11, 8, 10, 2, 5, 3, 4, 6, 1, 11, 8, 1, 2, 8, 18+2, 18+3, 18, 15,
            16, 14, 18+4, 18)),  # 1988/89 is the last year
        ("Antwerpen", (
            6, 1, 4, 3, 4, 4, 8, 16+3, 16+3, 16+10, 16+7, 16+10, 16+10, 16+6, 16+8, 18+3, 18+5, 18+4, 18+7, 18+4, 18,
            12, 16, 12, 18+1, 18+2, 18, 6, 13, 16, 5, 5, 5, 7, 4, 5, 3, 14, 9, 7, 8, 3, 5, 9, 13, 7, 8, 7, 11, 2, 2, 7,
        ...
        ("Gent", (
            ...
            6, 18+2, 17, 16, 4, 6, 15, 4, 3, 10, 18+1, 18+3, 18+4, 18+8, 19+12, 20+16+1, 16+10, 16+10, 16+8, 16, 3, 11,
            16+1, 15, 7, 12)),  # 1964/65 is the last year
        ("Kv mechelen", (
            8, 13, 7, 8, 6, 16+1, 16, 7, 10, 9, 13, 8, 9, 7, 7, 10, 13, 18+2, 18+13, 18+18+1, 18+18+7, 17, 18+1, 18, 11,
            18+1, 18+5, 17, 10, 11, 8, 3, 4, 2, 3, 1, 2, 2, 11, 12, 6, 18+1, 18, 18+5, 18+11, 18+10, 18+7, 17, 15, 17,
            7, 5, 6, 16+2, 16+9, 15, 14, 12, 6, 16+2)),  # 1964/65 is the last year
        ("Stvv", (
            9, 12, 9, 15, 12, 7, 10, 12, 13, 16+1, 16+3, 16+4, 16, 12, 4, 18+1, 17, 15, 15, 14, 13, 4, 8, 13, 13, 9, 14,
            11, 15, 8, 18+1, 18+7, 18+7, 17, 15, 7, 11, 18+1, 18+11, 18+5, 18+6, 18+6, 18+9, 18+11, 18+13, 18+8, 18+12,
        ...
        ("Westerlo", (
            11, 7, 18+1, 18+4, 16+1, 16+4, 16+7, 16, 15, 11, 16+1, 16+3, 15, 8, 12, 6, 9, 8, 9, 12, 6, 10, 14, 8, 6, 12,
        ...
        ("Charlerio", (
            13, 9, 6, 13, 3, 9, 6, 5, 8, 5, 10, 11, 16+1, 16, 13, 12, 8, 5, 11, 5, 15, 16, 12, 9, 16, 14, 13, 13, 7, 13,
            4, 7, 13, 8, 14, 11, 8, 7, 12, 18+4, 18+9, 18+10, 18+11, 18+6, 17, 9, 12, 16, 16, 14, 16+14, 16+3, 16+3, 15,
        ...
        ("Kas eupen", (
            16, 15, 15, 12, 13, 12, 15, 13, 16+2, 16+3, 16+2, 16+9, 16+3, 15, 16+4, 18+14, 18+13, 18+7, 18+8, 18+13,
